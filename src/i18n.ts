...
const translations: Record<SupportedLanguage, Record<string, TranslationValue>> = {
  en: {
    ...
    'kiosk.flagClue': 'Destination Country Flag',
    ...
    'kiosk.successFeedback': 'Cleared for {route}.',
    'kiosk.failFeedback': 'Wrong route: {route}. +{strike} strike',
    'kiosk.timeoutFeedback': 'Passenger lost patience. +{strike} strike',
    'kiosk.hud': 'Time: {time}s   Routed: {correct}/{processed}   Strikes: {strikes}/{max}',
    'kiosk.ambient': [
      'scanner glitch',
      'glass hum',
  ...
  ru: {
    ...
    'kiosk.flagClue': 'Флаг страны назначения',
    ...
    'kiosk.successFeedback': 'Направлен в {route}.',
    'kiosk.failFeedback': 'Неверный маршрут: {route}. +{strike} страйк',
    'kiosk.timeoutFeedback': 'Пассажир потерял терпение. +{strike} страйк',
    'kiosk.hud': 'Время: {time}с   Верно: {correct}/{processed}   Страйки: {strikes}/{max}',
    'kiosk.ambient': [
      'сбой сканера',
      'гул стекла',
  ...
  de: {
    ...
    'kiosk.flagClue': 'Flagge des Ziellandes',
    ...
    'kiosk.successFeedback': 'Fuer {route} freigegeben.',
    'kiosk.failFeedback': 'Falsche Route: {route}. +{strike} Strike',
    'kiosk.timeoutFeedback': 'Der Passagier hat die Geduld verloren. +{strike} Strike',
    'kiosk.hud': 'Zeit: {time}s   Korrekt: {correct}/{processed}   Strikes: {strikes}/{max}',
    'kiosk.ambient': [
      'scannerstoerung',
      'glasbrummen',

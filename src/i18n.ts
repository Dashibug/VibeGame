...
const translations: Record<SupportedLanguage, Record<string, TranslationValue>> = {
  en: {
    ...
    'kiosk.routingBrief': 'Case {caseId}  Compare speech, card, symbol and mark. Choose the correct country desk.',
  ...
  ru: {
    ...
    'kiosk.routingBrief': 'Дело {caseId}  Сверьте речь, карточку, символ и отметку. Выберите правильную страну назначения.',
  ...
  de: {
    ...
    'kiosk.routingBrief': 'Fall {caseId}  Vergleiche Sprache, Karte, Symbol und Markierung. Waehle das richtige Zielland.',
